...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args: Any, **kwargs):
        ...
        self.fields['username'].help_text='<span class="form-text text-muted">Wrong</span>'
        
        self.fields['password1'].widget.attrs['class']='form-control'
        self.fields['password1'].widget.attrs['placeholder']='password1'
        self.fields['password1'].label=''
        self.fields['password1'].help_text='<span class="form-text text-muted">Wrong</span>'
        
        self.fields['password2'].widget.attrs['class']='form-control'
        self.fields['password2'].widget.attrs['placeholder']='password2'
        self.fields['password2'].label=''
        self.fields['password2'].help_text='<span class="form-text text-muted">Wrong</span>'